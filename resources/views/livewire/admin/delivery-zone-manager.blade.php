            ...
            <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="fee" class="mt-1 w-full rounded-md border-gray-300">
                ...
                <div class="mt-6 flex justify-end gap-3">
                    ...
                    <button wire:click="create" class="bg-green-700 hover:bg-green-800 text-white text-sm font-semibold px-4 py-2 rounded-md">Save</button>
                </div>
            </div>
        </div>
    @endif
