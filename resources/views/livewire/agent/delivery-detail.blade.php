<div class="max-w-xl">
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" wire:model="cashCollected" class="mt-1 w-full rounded-md border-gray-300">
            ...
            <div>
                ...
                <input type="text" wire:model="denominationNotes" placeholder="e.g. Paid with ₦2000 notes, no change for ₦500" class="mt-1 w-full rounded-md border-gray-300">
            </div>
            <div>
            ...
            <button wire:click="markDelivered" wire:loading.attr="disabled" class="w-full bg-green-700 hover:bg-green-800 text-white font-semibold py-3 rounded-md">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
            <select wire:model="failureReason" class="w-full rounded-md border-gray-300">
                @foreach ($failureReasons as $reason)
                    <option value="{{ $reason->value }}">{{ str_replace('_', ' ', ucfirst($reason->value)) }}</option>
                @endforeach
            </select>
            <button wire:click="markFailed" wire:confirm="Mark this delivery as failed?" class="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 rounded-md">
