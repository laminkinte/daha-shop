                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    ...
                    <div class="p-3">
                        ...
                        <div class="flex gap-2 mt-2">
                            <button wire:click="addToCart({{ $wishlistItem->product->id }})" class="flex-1 text-xs bg-green-700 text-white rounded-md py-1.5">Add to Cart</button>
                            <button wire:click="remove({{ $wishlistItem->id }})" class="text-xs border border-gray-300 rounded-md px-2 text-gray-500">Remove</button>
                        </div>
                    </div>
                </div>
            @endforeach
